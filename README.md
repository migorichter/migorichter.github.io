...
### Technical Product Manager | Siemens EDA | Munich, Germany

---

## About Me

With **30 years of experience** in software product development for the automotive industry, I bring deep expertise in wire harness engineering, production preparation & manufacturing (KSK, MES), customer service, and standardized data exchange (KBL, VEC). My career spans hands-on R&D leadership through to global market development and platform strategy at Siemens.
...
### Mentor (Siemens) — R&D Technical Director, IES *(2019 – 2021)*
...
## Areas of Expertise
`Wire Harness Engineering` `Cloud/SaaS` `MES` `KSK` `KBL` `VEC` `Electric Vehicles` `Production Automation` `Sustainability` `3rd Party Integrations` `Product Strategy` `Market Development`